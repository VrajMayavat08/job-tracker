...
function Login() {
  ...
  return (
    <div className="min-h-screen bg-[var(--color-bg-deep)] flex items-center justify-center px-4">
      <div className="w-full max-w-sm bg-[var(--color-glass)] border border-[var(--color-glass-border)] rounded-2xl p-8">
        <h1 className="font-[var(--font-display)] text-2xl mb-1">Welcome back</h1>
        <p className="text-[var(--color-text-secondary)] text-sm mb-6">Log in to track your applications</p>
        ...
        <p className="text-sm text-[var(--color-text-secondary)] mt-6 text-center">
          ...
          <Link to="/register" className="text-[var(--color-violet-light)]">Sign up</Link>
        </p>
      </div>
    </div>
  );
